    ...
    record = repository.create(
        {
            ...
            "prompt_original_a": payload.prompt_original_a,
            "prompt_original_b": payload.prompt_original_b,
            "system_prompt_a": payload.system_prompt_a,
            "system_prompt_b": payload.system_prompt_b,
